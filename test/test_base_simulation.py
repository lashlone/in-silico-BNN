...
class TestBaseElement(unittest.TestCase):
    ...
    def setUp(self):
        element_1_shape = Circle(center=Vector2D(0.0, 0.0), radius=10.0)
        element_1 = Element(shape=element_1_shape, speed=Vector2D(1.0, 0.0), acceleration=Vector2D(0.0, 0.25))

        element_2_shape = Rectangle(center=Vector2D(720.0, 400.0), width=10.0, height=10.0, orientation=45.0)
        element_2 = Element(shape=element_2_shape, speed=Vector2D(-2.0, 2.0))

        element_3_shape = IsoscelesTriangle(center=Vector2D(1200.0, 400.0), base=10.0, height=10.0, orientation=180.0)
        element_3 = Element(shape=element_3_shape, speed=Vector2D(0.0, 0.0), acceleration=Vector2D(-1.0, 0.0))
    ...
    def test_simulation_step(self):
        expected_element_1_shape = Circle(center=Vector2D(10.0, 11.25), radius=10.0)
        expected_element_1 = Element(shape=expected_element_1_shape, speed=Vector2D(1.0, 2.5), acceleration=Vector2D(0.0, 0.25))

        expected_element_2_shape = Rectangle(center=Vector2D(700.0, 420.0), width=10.0, height=10.0, orientation=45.0)
        expected_element_2 = Element(shape=expected_element_2_shape, speed=Vector2D(-2.0, 2.0))

        expected_element_3_shape = IsoscelesTriangle(center=Vector2D(1155.0, 400.0), base=10.0, height=10.0, orientation=180.0)
        expected_element_3 = Element(shape=expected_element_3_shape, speed=Vector2D(-10.0, 0.0), acceleration=Vector2D(-1.0, 0.0))
