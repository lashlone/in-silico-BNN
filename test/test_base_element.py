...
class TestBaseElement(TestCase):
    ...
    def setUp(self):
        main_element_shape = Circle(center=Point(0.0, 0.0), radius=5.0, generator=TestBaseElement.generator)
    ...
    def test_element_set_state(self):
        expected_element_shape = Circle(center=Point(0.0, 3.5), radius=5.0, generator=TestBaseElement.generator)
    ...
    def test_element_update(self):
        expected_element_shape = Circle(center=Point(1.0, -1.0), radius=5.0, generator=TestBaseElement.generator)
